...
class AdminCitas{
  ...
  mostrar(){
    ...
    this.citas.forEach(cita => {
      ...
      //Agregando funcion de editar al boton
      ...
      //Agregando funcion de eliminar al boton
...
inputEmail.addEventListener("input", datosCita)
...
function submitCita(e){
  ...
  if(editando){
    ...
    new Notificacion({
      texto: "Paciente editado exitosamente",
      tipo: "exito"
    })
  }else{
    citas.agregar({...citaObj})
    new Notificacion({
      texto: "Paciente registado exitosamente",
      tipo: "exito"
    })
  }
